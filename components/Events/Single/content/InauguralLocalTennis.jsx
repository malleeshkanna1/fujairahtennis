  ...
  return (
    <div className="mt-5">
      <h1 className={`text-center ${SingleNewsStyle["Newsheading"]}`}>
        Participate in the Inaugural Local Tennis Tournament at Tennis and
        Country Club Fujairah!
      </h1>
      <p className={"text-center mt-4 " + SingleNewsStyle["dateTime"]}>
        <i className="bx bx-calendar"></i> Feb 2, 2018 @ 9:00 am - Feb 3, 2018 @
        10:30 pm
      </p>
      <div className="mt-5">
        <p className={SingleNewsStyle["passage"]}>
          Tennis and Country Club Fujairah is excited to host its First Local
          Tennis Tournament on February 2nd and 3rd, 2018. This event welcomes
          men, women, and children of all skill levels to join in a weekend of
          competitive tennis and community fun. Matches will start at 9 AM each
          day, providing ample time for players to showcase their abilities and
          compete in a friendly atmosphere.
        </p>
        <p className={SingleNewsStyle["passage"]}>
          The entry fee is AED 50 per person for each draw, which covers your
          participation and contributes to the overall event organization.
          Ensure you register before the deadline to secure your place—sign-ups
          and entrance fees close at 10:30 PM on February 1st, 2018. Don’t miss
          out on this opportunity to compete and enjoy the sport!
        </p>
        <p className={SingleNewsStyle["passage"]}>
          If you’re struggling to find a partner for the tournament, we’ve got
          you covered. Simply post on the Event Page to connect with other
          players looking for partners. This makes it easy to find a match and
          participate in the tournament without any stress.
        </p>
        <p className={SingleNewsStyle["passage"]}>
          This local tennis tournament is not just a competition; it’s a chance
          to engage with fellow tennis enthusiasts, experience the vibrant
          community spirit, and have a great time. Whether you’re an experienced
          player or just starting out, this tournament is designed to offer a
          rewarding experience for everyone.
        </p>
        <p className={SingleNewsStyle["passage"]}>
          Mark your calendar for February 2nd and 3rd, 2018, and be part of this
          exciting event at Tennis and Country Club Fujairah. Register now, get
          ready to play, and enjoy a weekend of thrilling tennis matches and
          local camaraderie!
        </p>
      </div>
      <div className="mt-4">
...
export default InauguralLocalTennis;
